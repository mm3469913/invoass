...
class InvoicesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('pic')) {
            ...
            $attachmentses->invoice_number = $invoice_number;
            $attachmentses->Created_by = Auth::user()->name;
            $attachmentses->invoice_id = $invoice_id;
            $attachmentses->save();

            // move pic
            $imageName = $request->pic->getClientOriginalName();
            $request->pic->move(public_path('Attachmentses/' . $invoice_number), $imageName);
        }
    ...
    public function destroy(Request $request)
    {
        ...
        $invoices = invoices::where('id', $id)->first();
        $Details = invoice_attachmentses::where('invoice_id', $id)->first();
